...
description: Use when implementing any new feature, bug fix, or refactoring where tests should drive design. Enforces explicit red-green-refactor prompting because Claude defaults to implementation-first. Includes anti-patterns and integration with TodoWrite, Plan Mode, hooks, and sub-agents.
---
